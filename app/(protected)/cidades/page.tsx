...
import { useCidadeContext } from "./components/cidade-context";
...
import CidadeWrapper from "./components/cidade-wrapper";
...
const ListTable = () => {
    ...
    const { cidades, isLoading } = useCidadeContext();
                                    ...
                                    <TableRow key={row.id} data-state={row.getIsSelected() && "selected"}>
                                        {row.getVisibleCells().map((cell) => (
                                            <TableCell
                                                ...
                                                style={{
                                                    width: cell.column.id === 'actions' ? 100 : 'auto',
                                                    maxWidth: cell.column.id === 'actions' ? 100 : 'auto',
                                                }}
                                            >
